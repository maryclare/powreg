...
sampler <- function(DUty, Vt, d, W, sigsq, tausq, q, samples, start, seed, burn) {
    .Call('_powreg_sampler', PACKAGE = 'powreg', DUty, Vt, d, W, sigsq, tausq, q, samples, start, seed, burn)
}
