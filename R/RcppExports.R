...
rtnormboundunif <- function(mu, sd, lstd, rstd) {
    .Call('_powreg_rtnormboundunif', PACKAGE = 'powreg', mu, sd, lstd, rstd)
}

rtnormboundnorm <- function(mu, sd, lstd, rstd) {
    .Call('_powreg_rtnormboundnorm', PACKAGE = 'powreg', mu, sd, lstd, rstd)
}

rtnormboundhalf <- function(mu, sd, lstd, rstd) {
    .Call('_powreg_rtnormboundhalf', PACKAGE = 'powreg', mu, sd, lstd, rstd)
}

rtnormboundtexp <- function(mu, sd, lstd, rstd) {
    .Call('_powreg_rtnormboundtexp', PACKAGE = 'powreg', mu, sd, lstd, rstd)
}
